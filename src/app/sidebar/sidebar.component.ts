...
export class SidebarComponent implements OnInit {
  ...
  newEvent(e){
    ...
    this.event = new Event(0,this.eventForm.value.event_title,this.eventForm.value.event_description,"",0,this.eventForm.value.event_date,this.eventForm.value.event_time,this.eventForm.value.event_address,0,0);
